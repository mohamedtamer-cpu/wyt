...
const translations = {
  en: {
    ...
    'stat-machines':'Machines Deployed','stat-locations':'Partner Locations','stat-uptime':'Availability',
    ...
    'about-p2':'We bring smart vending to spaces in Egypt, with cashless payments and products chosen for the people who use them.',
    ...
    'loc-cta-title':'Want to see your space here?','loc-cta-sub':'Bring WYT vending to your space. Contact us to get started.',
  ...
  ar: {
    ...
    'stat-machines':'ماكينة منتشرة','stat-locations':'موقع شريك','stat-uptime':'الإتاحة',
    ...
    'about-p2':'نقدم حلول البيع الذكي للمساحات في مصر، مع الدفع الإلكتروني ومنتجات مختارة لتناسب مستخدميها.',
    ...
    'about-badge':'البيع الذكي في مصر',
    ...
    'loc-cta-title':'تريد مكانك هنا؟','loc-cta-sub':'أضف ماكينة WYT إلى مساحتك. تواصل معنا للبدء.',
